        ...
        <div className='bg-[#111827] h-screen'>
            ...
            <div className='flex flex-wrap'>
                <div className=' mx-auto md:w-1/2 mt-5 '>
                    ...
                    <svg className='animate-bounce w-10 h-10 text-white mx-auto' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
